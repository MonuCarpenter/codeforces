...
module.exports = {
    get: function(args, cb) {
        ...
        var contestNumber = filename.substr(0, filename.length - 1),
            problemAlpha = filename[filename.length - 1];
   
        if (!_.isString(args['0']) || !_.isString(problemAlpha) || _.isNaN(contestNumber)) {
